...
; CHECK-NEXT:    v_mul_u32_u24_e32 v2, 0x180, v63
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 5, v62
; CHECK-NEXT:    v_lshlrev_b32_e32 v1, 5, v72
; CHECK-NEXT:    v_add_nc_u32_e32 v3, v2, v0
; CHECK-NEXT:    v_add_nc_u32_e32 v7, v2, v1
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[3:6], v3, s[64:65]
; CHECK-NEXT:    global_load_dwordx4 v[7:10], v7, s[64:65]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_xor_b32_e32 v57, v8, v4
; CHECK-NEXT:    v_xor_b32_e32 v56, v7, v3
; CHECK-NEXT:    v_xor_b32_e32 v46, v10, v6
; CHECK-NEXT:    v_xor_b32_e32 v45, v9, v5
; CHECK-NEXT:    v_or_b32_e32 v4, v57, v46
; CHECK-NEXT:    v_or_b32_e32 v3, v56, v45
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[3:4]
; CHECK-NEXT:    s_cbranch_execz .LBB0_27
; CHECK-NEXT:  ; %bb.29: ; in Loop: Header=BB0_28 Depth=1
; CHECK-NEXT:    v_add_co_u32 v3, s4, s64, v2
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, s65, 0, s4
; CHECK-NEXT:    v_mov_b32_e32 v31, v40
; CHECK-NEXT:    v_add_co_u32 v1, vcc_lo, v3, v1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v2, null, 0, v4, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v3, vcc_lo, v3, v0
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, 0, v4, vcc_lo
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx2 v[58:59], v[1:2], off offset:24
; CHECK-NEXT:    global_load_dwordx2 v[60:61], v[3:4], off offset:24
...
; CHECK-NEXT:    v_lshlrev_b32_e32 v7, 6, v72
; CHECK-NEXT:    v_lshlrev_b32_e32 v9, 12, v63
; CHECK-NEXT:    v_mul_u32_u24_e32 v10, 0x180, v73
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
; CHECK-NEXT:    v_xor_b32_e32 v6, v61, v59
; CHECK-NEXT:    v_lshlrev_b32_e32 v8, 16, v5
; CHECK-NEXT:    v_lshlrev_b32_e32 v11, 16, v45
; CHECK-NEXT:    v_or3_b32 v7, v7, v9, v62
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v10, v0
; CHECK-NEXT:    v_lshrrev_b64 v[5:6], 16, v[5:6]
; CHECK-NEXT:    v_or_b32_e32 v4, v8, v4
; CHECK-NEXT:    v_or_b32_e32 v2, v11, v2
; CHECK-NEXT:    global_store_dword v0, v7, s[66:67]
; CHECK-NEXT:    global_store_dwordx4 v0, v[1:4], s[66:67]
; CHECK-NEXT:    global_store_dwordx2 v0, v[5:6], s[66:67]
